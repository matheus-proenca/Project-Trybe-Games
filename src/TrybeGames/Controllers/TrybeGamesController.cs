...
public class TrybeGamesController
{
    ...
    public void AddGameStudio()
    {
        ...
        NewGameStudio.Add(new GameStudio { Name = GameStudioName, Id = GameStudioCount + 1 });
    }
    ...
    public void AddGame()
    {
        ...
        DateTime gameRelease = DateTime.ParseExact(Console.ReadLine(), "dd/MM/yyyy", CultureInfo.InvariantCulture);
